...
$('#form').submit(function (e) {
	...
	function showformValues(form){
		...
		$.each(formValues, function(index, field){
			...
			// $("#results").find("#"+address+"_result").text(field.value);

			// $("#results").find("#"+city+"_result").text(field.value);

			// $("#results").find("#"+province+"_result").text(field.value);

			// $("#results").find("#"+pc+"_result").text(field.value);
